...
// NOTE: the "bag" column in CQL is defined as "bag map<text, int>", which gets mapped (by the auto schema generation) to the
//       unfriendly type of "EntryStringKeyIntValueInput"
// NOTE: "updatecarts" is part of the autogenerated schema. Camel casing more friendly?
...
/* NOTE: The variable/param needs to be 'cart_id', with 'cart' you get the following error. Fuck knows if I know why...
...
class App extends Component {
  ...
  updateCart = (counters) => {
    ...
    // NOTE: In order to satisfy the autogenerated schema, we have to turn this
    // { Adult: 3 } into this {key: "Adult", value: 3} to satisfy the schema.
    var bag = []
